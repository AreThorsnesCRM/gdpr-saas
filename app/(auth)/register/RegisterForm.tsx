...
export default function RegisterForm() {
  ...
  async function handleRegister(e: React.FormEvent) {
    ...
    // Fire-and-forget: records the DPA acceptance with the server-seen IP/user-agent.
    // Not blocking on the response — a failure here shouldn't stop registration, and
    // the callback route only backfills account_id if a row exists, it doesn't require one.
    fetch("/api/dpa/accept", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
